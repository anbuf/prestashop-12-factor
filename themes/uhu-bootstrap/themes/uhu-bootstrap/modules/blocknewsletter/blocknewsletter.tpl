...
<div id="newsletter_block_left" class="block">
	...
	<p class="description">{l s='Subscribe to our mailing list to receive updates on new arrivals, special offers and other discount information.' mod='blocknewsletter'}</p>
	...
	<div class="subscribe-bottom">
		<p>{l s='No thanks! I\'m not interested in this promotion' mod='blocknewsletter'}</p>
		<input id="dont-show-again" type="checkbox" class="checker"><span>{l s='Don\'t show this popup again' mod='blocknewsletter'}</span>
	</div>
